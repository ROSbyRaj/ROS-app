...
public class downloadfile extends AsyncTask
{
	...
	String username;
	String password;
	public downloadfile(Context context,String username,String url,String packagename,String destpath,int MODE){
		this.context = context; this.urlStr =url; this.getPackageName= packagename; this.destinationFilePath = destpath; this.username = username; this.password = password;
	}
	...
	protected Object doInBackground(Object[] p1)
	{
		...
		try
		{
			unzip("/data/data/" + getPackageName+"/files/system.zip", "/data/data/" + getPackageName + "/files/"+username+"/");
		}
		catch (IOException e)
		{}finally{
			File deletezip = new File("/data/data/" +getPackageName + "/files/system.zip");
			deletezip.delete();
			/*
